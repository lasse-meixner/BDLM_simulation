...
```{r}
extract_results_dml(fit_random, data_random$gamma, type = "DML_B2", list(setting = "random", N = 200, P = 100, sigma = 1))
```
...
```{r}
results_parallel <- run_simulation_parallel(model_type = c("BDML", "BLRs"), N = 200, P = 100, setting = "fixed", sigma = c(1,2,4), simulation_size = 3, batch_size = 4, n_cores = 4)
